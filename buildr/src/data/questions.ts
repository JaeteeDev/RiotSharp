...
export const questions: QuizQuestion[] = [
  ...
  {
    id: 'q-wall-3', type: 'multiple-choice', topic: 'Wall Framing', learningAreaId: 'wall-framing', unitCode: 'CPCCCA3004',
  ...
  {
    id: 'q-wall-4', type: 'order-steps', topic: 'Wall Framing', learningAreaId: 'wall-framing', unitCode: 'CPCCCA3004',
  ...
  {
    id: 'q-wall-5', type: 'true-false', topic: 'Wall Framing', learningAreaId: 'wall-framing', unitCode: 'CPCCCA3004',
    prompt: 'Bracing type and quantity for a wall frame should be taken directly from the project\'s bracing design/drawings, not estimated on site.',
    options: ['True', 'False'],
    correctIndex: 0,
    explanation: 'True — bracing resists significant lateral (wind) loads. Type, location and amount are engineered/specified and must be followed exactly, never estimated.',
    difficulty: 2,
  },
